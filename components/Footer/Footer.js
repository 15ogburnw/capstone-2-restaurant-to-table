...
import placeholderLogo from '@/public/img/rtt-logos/alogo-4.webp'
    ...
    <footer className="bg-white border-t shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.075)]">
      <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center text-center">
          <Link href="#" className="">
            <Image src="https://en.expensereduction.com/wp-content/uploads/2018/02/logo-placeholder.png" width={400} height={300} alt="logo" />
          </Link>
