        ...
        <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-2xl shadow-slate-700  lg:max-w-4xl">
          ...
          <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <div className="flex items-center justify-between mt-4">
              <span className="w-1/5 border-b-2 border-green-400 lg:w-1/4"></span>

              <a
                href="#"
                className="text-xs font-semibold text-center text-green-500 uppercase  hover:underline"
              >
                or login with email
              </a>
            ...
            <div className="mt-6">
              <button className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-emerald-500 rounded-lg hover:bg-emerald-300 focus:outline-none focus:ring focus:ring-emerald-500 focus:ring-opacity-50">
                Sign In
              </button>
            </div>
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              <a
                href="#"
                className="text-xs font-semibold text-green-500 uppercase  hover:underline"
              >
                or sign up
              </a>
