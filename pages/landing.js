      ...
      <section className="bg-base-accent flex flex-col items-center h-screen w-screen overflow-hidden">
        <header className="mx-auto relative w-full max-w-7xl bg-">
          <div className="flex align-middle flex-row items-center justify-between px-12  py-6">
            <div className="hidden sm:inline-block">
              <RttFullLogo mainColor="primary-700" secondColor="primary-500" />
            </div>

            <nav className="items-start flex-grow flex flex-row mb-2 sm:justify-end justify-center pb-0 ">
              <div className="items-center inline-flex gap-2 lg:ml-auto md:mt-0 mt-3 list-none">
                <Link
                  href="/auth/login"
                  className="text-primary-700 text-2xl py-2 relative group transition-all duration-150 hover:scale-110  font-extrabold lg:mx-4 md:mx-3 mx-2">
                  Login
                </Link>
                <Link
                  href="/auth/signup"
        ...
        <main className=" relative w-full  max-w-7xl md:px-12 z-30 mx-auto px-5 relative">
          <div className="text-center lg:text-left">
            ...
            <div className="invisible  z-10 lg:visible  text-lg rounded-md px-3  mt-7 bg-primary-700  inline-block">
