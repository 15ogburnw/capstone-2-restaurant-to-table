  ...
  return (
    <>
      <section className="bg-[#eaeadf] flex flex-col items-center h-screen relative overflow-hidden">
        <header className="mx-auto relative w-full max-w-7xl bg-">
          <div className="mx-auto relative w-full  flex  flex-row items-center justify-between px-12  py-6">
            <div className="text-primary-800 text-sm items-center  flex flex-row justify-between lg:justify-start">
              <Link
                href="/dashboard"
                className="text-lg font-bold  px-1.5 py-1 leading-none border-4 border-primary-900 hover:border-primary-900/60 text-primary-900 hover:text-primary-900/60">
                Restaurant to Table
              </Link>
            </div>
        ...
        <div className="mx-auto relative w-full max-w-7xl h-screen">
          <SVG
            src="img/fillers/avocados.svg"
            className="absolute bottom-120 rounded-[525px] right-0 overflow-hidden z-10"
            height={350}
            alt="avocados"></SVG>
        </div>
      </section>
