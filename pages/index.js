  ...
  return (
    <>
      <section className="bg-base flex flex-col items-center h-screen w-screen overflow-hidden">
        ...
        <main className=" relative w-full  max-w-7xl md:px-12 z-30 mx-auto px-5 ">
